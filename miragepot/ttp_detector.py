...
SINGLE_COMMAND_PATTERNS: List[Tuple[str, str, str, AttackStage, str, str]] = [
    ...
    # =========================================================================
    # NEW TECHNIQUES - Phase 1 Enhancement (April 2026)
    # Adding 12 additional MITRE ATT&CK techniques for expanded coverage
    # =========================================================================
    ...
    (
        ...
        AttackStage.RECONNAISSANCE,
        "medium",
        "Logged-in users discovery via w command",
    ),
    (
        r"^users\b",
        "T1033",
        ...
        AttackStage.RECONNAISSANCE,
        "medium",
        "Logged-in users discovery via users command",
    ),
    (
        r"^last\s+-a",
        "T1033",
        ...
        AttackStage.RECONNAISSANCE,
        "medium",
        "User login history with hostnames",
    ),
    (
        r"^finger\b",
        "T1033",
        ...
        AttackStage.RECONNAISSANCE,
        "medium",
        "User information discovery via finger",
    ),
    (
        r"cat\s+/var/log/wtmp",
        "T1033",
        "System Owner/User Discovery",
        AttackStage.RECONNAISSANCE,
        "high",
        "Direct wtmp access for user login history",
    ),
    ...
    (
        r"cat\s+/proc/net/(tcp|udp)",
        "T1049",
        "System Network Connections Discovery",
        AttackStage.RECONNAISSANCE,
        "high",
        "Direct /proc network state access",
    ),
    ...
    (
        ...
        AttackStage.RECONNAISSANCE,
        "medium",
        "ARP table enumeration for local hosts",
    ),
    (
        r"for\s+.*\s+in\s+.*ping",
        "T1018",
    ...
    (
        ...
        AttackStage.RECONNAISSANCE,
        "medium",
        "Init script enumeration",
    ),
    (
        r"ls\s+/etc/systemd/system",
        "T1007",
        "System Service Discovery",
        AttackStage.RECONNAISSANCE,
        "medium",
    ...
    (
        ...
        AttackStage.DEFENSE_EVASION,
        "high",
        "Binary copied to system path",
    ),
    (
        r"mv\s+.*\s+\.(hidden|config)",
        "T1036",
        "Masquerading",
        AttackStage.DEFENSE_EVASION,
        "high",
        "File renamed to hidden name",
    ),
    (
        r"ln\s+-s.*\s+/usr/(s)?bin/",
        "T1036",
        "Masquerading",
        AttackStage.DEFENSE_EVASION,
        "high",
        "Symlink created in system path",
    ),
    (
        r"alias\s+\w+=",
        "T1036",
    ...
    (
        ...
        AttackStage.DEFENSE_EVASION,
        "high",
        "PATH manipulation for command hijacking",
    ),
    # T1119 - Automated Collection
    (
        r"find\s+.*-name.*\.(doc|pdf|xls|txt|key|pem)",
        "T1119",
        "Automated Collection",
        AttackStage.COLLECTION,
        "high",
        "Automated search for sensitive file types",
    ),
    (
        r"for\s+.*\s+in\s+.*find",
        "T1119",
        ...
        AttackStage.COLLECTION,
        "high",
        "Scripted file collection loop",
    ),
    (
        r"locate\s+.*\.(pem|key|crt)",
        "T1119",
        "Automated Collection",
        AttackStage.COLLECTION,
        "high",
        "Automated certificate/key search",
    ),
    (
        r"grep\s+-r.*password\s+/",
        "T1119",
        "Automated Collection",
        AttackStage.COLLECTION,
        "high",
    ...
    (
        r"curl\s+.*-X\s+POST\s+.*-d\s+@",
        "T1041",
        "Exfiltration Over C2 Channel",
        AttackStage.EXFILTRATION,
        "high",
        "Data POST exfiltration via curl",
    ),
    (
        ...
        AttackStage.EXFILTRATION,
        "high",
        "Binary data exfiltration via curl",
    ),
    (
        r"nc\s+.*<\s+/",
        "T1041",
    ...
    (
        ...
        AttackStage.EXFILTRATION,
        "high",
        "Data piped to netcat for exfiltration",
    ),
    (
        ...
        AttackStage.EXFILTRATION,
        "high",
        "Encrypted exfiltration via openssl",
    ),
    ...
    (
        r"cat\s+.*\.password-store",
        "T1555",
        "Credentials from Password Stores",
        AttackStage.CREDENTIAL_ACCESS,
        "high",
        "Pass password store access",
    ),
    (
        r"keepassxc-cli",
        "T1555",
        ...
        AttackStage.CREDENTIAL_ACCESS,
        "high",
        "KeePassXC database access attempt",
    ),
    (
    ...
    (
        ...
        AttackStage.CREDENTIAL_ACCESS,
        "high",
        "Netrc credentials file access",
    ),
    # T1490 - Inhibit System Recovery
    (
        r"rm\s+.*-rf\s+/var/backups",
        "T1490",
    ...
    (
        ...
        AttackStage.IMPACT,
        "high",
        "Secure backup file deletion",
    ),
    (
        r"lvremove\s+.*snapshot",
        "T1490",
        "Inhibit System Recovery",
        AttackStage.IMPACT,
        "high",
        "LVM snapshot removal",
    ),
    (
        ...
        AttackStage.IMPACT,
        "high",
        "Btrfs snapshot deletion",
    ),
    (
        r"systemctl\s+(stop|disable)\s+.*backup",
        "T1490",
        "Inhibit System Recovery",
        AttackStage.IMPACT,
        "high",
    ...
    (
        r"cp\s+.*\s+(/tmp|/dev/shm)/",
        "T1074",
        "Data Staged",
        AttackStage.COLLECTION,
        "medium",
        "File staged to temporary location",
    ),
    (
        r"mv\s+.*\s+/var/tmp/\.",
        "T1074",
        ...
        AttackStage.COLLECTION,
        "high",
        "File moved to hidden staging location",
    ),
    (
        r"tar\s+.*-cf.*(/tmp|/dev/shm)",
        "T1074",
        "Data Staged",
        AttackStage.COLLECTION,
        "high",
        "Archive created in staging location",
    ),
]
